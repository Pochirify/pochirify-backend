...
type User struct {
	...
	PhoneNumberDigest string    `spanner:"PhoneNumberDigest" json:"PhoneNumberDigest"` // PhoneNumberDigest
	IsAuthenticated   bool      `spanner:"IsAuthenticated" json:"IsAuthenticated"`     // IsAuthenticated
...
func (u *User) columnsToPtrs(cols []string, customPtrs map[string]interface{}) ([]interface{}, error) {
	...
	for _, col := range cols {
		...
		case "ID":
			ret = append(ret, &u.ID)
		case "PhoneNumberDigest":
			ret = append(ret, &u.PhoneNumberDigest)
		case "IsAuthenticated":
			ret = append(ret, &u.IsAuthenticated)
		case "CreateTime":
			ret = append(ret, &u.CreateTime)
		case "UpdateTime":
			ret = append(ret, &u.UpdateTime)
		default:
