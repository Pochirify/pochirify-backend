module github.com/Pochirify/pochirify-backend/dev/tools
...
require (
	...
	github.com/MakeNowJust/memefish v0.0.0-20221115050542-593cc9bc6771 // indirect
	...
	go.mercari.io/yo v0.5.3 // indirect
